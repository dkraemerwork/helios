...
const TX_MAP_PUT_REQUEST_TYPE = 0x110100;
const TX_MAP_GET_REQUEST_TYPE = 0x110200;
const TX_MAP_PUT_IF_ABSENT_REQUEST_TYPE = 0x110600;
const TX_MAP_REMOVE_REQUEST_TYPE = 0x110900;
const TX_MAP_DELETE_REQUEST_TYPE = 0x110a00;
const TX_MAP_KEY_SET_REQUEST_TYPE = 0x110c00;
const TX_MAP_VALUES_REQUEST_TYPE = 0x110e00;
...
const TX_LIST_ADD_REQUEST_TYPE = 0x160100;
const TX_LIST_REMOVE_REQUEST_TYPE = 0x160200;
const TX_LIST_SIZE_REQUEST_TYPE = 0x160300;

const TX_SET_ADD_REQUEST_TYPE = 0x170100;
const TX_SET_REMOVE_REQUEST_TYPE = 0x170200;
const TX_SET_SIZE_REQUEST_TYPE = 0x170300;

const TX_MULTIMAP_PUT_REQUEST_TYPE = 0x100100;
const TX_MULTIMAP_GET_REQUEST_TYPE = 0x100200;
const TX_MULTIMAP_REMOVE_REQUEST_TYPE = 0x100300;
const TX_MULTIMAP_VALUE_COUNT_REQUEST_TYPE = 0x100500;
const TX_MULTIMAP_SIZE_REQUEST_TYPE = 0x100600;
