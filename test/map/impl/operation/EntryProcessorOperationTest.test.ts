...
import { EntryOperation } from '@helios/map/impl/operation/EntryOperation';
import { PartitionWideEntryOperation } from '@helios/map/impl/operation/PartitionWideEntryOperation';
