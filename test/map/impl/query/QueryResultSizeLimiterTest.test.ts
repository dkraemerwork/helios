...
import { QueryResultSizeLimiter } from '@helios/map/impl/query/QueryResultSizeLimiter';
import { QueryResultSizeExceededException } from '@helios/map/QueryResultSizeExceededException';
import { PartitionIdSet } from '@helios/internal/util/collection/PartitionIdSet';
...
function buildContext(
    ...
    const ctx: MapServiceContext = {
        ...
        getRecordStore: (_partitionId: number, _mapName: string) => {
            ...
            return {
                size: () => lastValue,
            } as unknown as import('@helios/map/impl/recordstore/RecordStore').RecordStore;
        },
