...
import { HeliosAutoConfigurationModule } from '@helios/nestjs/autoconfiguration/HeliosAutoConfigurationModule';
import { HeliosBoot4ObjectExtractionModule } from '@helios/nestjs/autoconfiguration/HeliosBoot4ObjectExtractionModule';
...
class StubHeliosInstance implements HeliosInstance {
    ...
    getName(): string { return this.instanceName; }
    shutdown(): void {}
...
describe('HeliosAutoConfigurationModule.forRoot', () => {
    ...
    it('exports HELIOS_INSTANCE_TOKEN', () => {
        const dm = HeliosAutoConfigurationModule.forRoot(new StubHeliosInstance('x'));
...
describe('HeliosBoot4ObjectExtractionModule', () => {
    ...
    const allObjects = [
        ...
        { token: RINGBUFFER_TOKEN, name: 'ringbuffer', type: 'Ringbuffer' as const },
    ];
