...
// Response initial frame: just backupAcks(1) = 13 bytes total (offset 12 + 1)
...
export class MapFetchNearCacheInvalidationMetadataCodec {
    static readonly REQUEST_MESSAGE_TYPE: number = 0x013D00;  // 81152
    static readonly RESPONSE_MESSAGE_TYPE: number = 0x013D01; // 81153
    ...
    static encodeRequest(names: string[], uuid: string | null): ClientMessage {
        ...
        buf.writeUInt32LE(MapFetchNearCacheInvalidationMetadataCodec.REQUEST_MESSAGE_TYPE >>> 0, ClientMessage.TYPE_FIELD_OFFSET);
    ...
    static encodeResponse(
        ...
        buf.writeUInt32LE(MapFetchNearCacheInvalidationMetadataCodec.RESPONSE_MESSAGE_TYPE >>> 0, ClientMessage.TYPE_FIELD_OFFSET);
