/**
 * Port of {@code com.hazelcast.cache.impl.operation.CacheGetInvalidationMetaDataOperation}.
 *
...
export interface InvalidationMetaDataResponse {
    /** cache-name → list of (partitionId, sequence) pairs (only non-zero sequences included) */
    namePartitionSequenceList: Map<string, PartitionSequenceEntry[]>;
    /** partitionId → partition UUID */
    partitionUuidList: Map<number, string>;
}

export class CacheGetInvalidationMetaDataOperation {
