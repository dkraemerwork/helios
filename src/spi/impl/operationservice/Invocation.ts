...
import type { Invocable } from '@zenystx/core/spi/impl/operationservice/InvocationRegistry';
...
import { RetryableException } from '@zenystx/core/spi/impl/operationservice/RetryableException';
