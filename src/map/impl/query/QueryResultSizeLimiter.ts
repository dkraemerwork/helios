 ...
 */
import type { MapServiceContext } from '@helios/map/impl/MapServiceContext';
import type { ILogger } from '@helios/test-support/ILogger';
import { ClusterProperty } from '@helios/spi/properties/ClusterProperty';
...
export class QueryResultSizeLimiter {
    ...
    private _getLocalPartitionSize(
        mapName: string,
        localPartitions: import('@helios/internal/util/collection/PartitionIdSet').PartitionIdSet,
    ...
    private _getMaxResultLimit(props: import('@helios/spi/properties/HeliosProperties').HeliosProperties): number {
    ...
    private _getMaxLocalPartitionsLimitForPreCheck(
        props: import('@helios/spi/properties/HeliosProperties').HeliosProperties,
    ): number {
