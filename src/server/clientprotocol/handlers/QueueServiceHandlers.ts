...
const QUEUE_CONTAINS_REQUEST_TYPE          = 0x030500;
const QUEUE_CONTAINS_RESPONSE_TYPE        = 0x030501;
const QUEUE_CONTAINS_ALL_REQUEST_TYPE     = 0x030600;
const QUEUE_CONTAINS_ALL_RESPONSE_TYPE    = 0x030601;
const QUEUE_ADD_ALL_REQUEST_TYPE          = 0x030800;
const QUEUE_ADD_ALL_RESPONSE_TYPE         = 0x030801;
const QUEUE_COMPARE_REMOVE_ALL_REQUEST_TYPE  = 0x030900;
const QUEUE_COMPARE_REMOVE_ALL_RESPONSE_TYPE = 0x030901;
const QUEUE_COMPARE_RETAIN_ALL_REQUEST_TYPE  = 0x030a00;
const QUEUE_COMPARE_RETAIN_ALL_RESPONSE_TYPE = 0x030a01;
const QUEUE_TO_ARRAY_REQUEST_TYPE         = 0x030b00;
const QUEUE_TO_ARRAY_RESPONSE_TYPE        = 0x030b01;
const QUEUE_DRAIN_TO_REQUEST_TYPE         = 0x030c00;
const QUEUE_DRAIN_TO_RESPONSE_TYPE        = 0x030c01;
const QUEUE_DRAIN_TO_MAX_REQUEST_TYPE     = 0x030d00;
const QUEUE_DRAIN_TO_MAX_RESPONSE_TYPE    = 0x030d01;
const QUEUE_ITERATOR_REQUEST_TYPE         = 0x030e00;
const QUEUE_ITERATOR_RESPONSE_TYPE        = 0x030e01;
const QUEUE_IS_EMPTY_REQUEST_TYPE         = 0x030f00;
const QUEUE_IS_EMPTY_RESPONSE_TYPE        = 0x030f01;
const QUEUE_TAKE_REQUEST_TYPE             = 0x031000;
const QUEUE_TAKE_RESPONSE_TYPE            = 0x031001;
const QUEUE_PUT_REQUEST_TYPE              = 0x031100;
const QUEUE_PUT_RESPONSE_TYPE             = 0x031101;
const QUEUE_REMAINING_CAPACITY_REQUEST_TYPE  = 0x031200;
const QUEUE_REMAINING_CAPACITY_RESPONSE_TYPE = 0x031201;
const QUEUE_ADD_LISTENER_REQUEST_TYPE     = 0x031300;
const QUEUE_ADD_LISTENER_RESPONSE_TYPE    = 0x031301;
const QUEUE_REMOVE_LISTENER_REQUEST_TYPE  = 0x031400;
const QUEUE_REMOVE_LISTENER_RESPONSE_TYPE = 0x031401;
