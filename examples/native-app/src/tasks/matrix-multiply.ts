 ...
 * This is the kind of work you'd offload to scatter workers in production
 * (ML inference, data transforms, image processing).
 */
...
interface MatrixResult {
  size: number;
  /** Trace value: sum of diagonal elements of the result matrix. */
  trace: number;
  durationMs: number;
  worker: string;
  label?: string;
